...
pub struct Config {
	...
	///
	/// Sentry reads this as a fraction, so it must lie between 0.0 and 1.0
	/// inclusive when Sentry is enabled. High values may impact performance;
	/// 0.0 disables sampling.
	///
	/// default: 0.15
