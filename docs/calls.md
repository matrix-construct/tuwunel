...
There are two ways of setting up voice and video calling for use with Matrix:
  ...
  - MatrixRTC/Element Call (using a [Livekit](https://github.com/livekit/livekit) backend).
...
To set up legacy calling, see the [TURN documentation](calls/turn.md). Note: if you are also setting up MatrixRTC, additionally review the [External TURN Integration](calls/matrix_rtc.md#external-turn-integration) section of the MatrixRTC documentation.

To set up MatrixRTC/Element Call, see the [MatrixRTC documentation](calls/matrix_rtc.md).
