...
default_playwright_skip="oidc-native|backups-mas|login-sso|soft_logout_oauth|register/email|forgot-password"
...
#   These stems hold out specs that need a MAS, OAuth, or SMTP sidecar
